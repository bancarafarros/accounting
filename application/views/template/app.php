...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('public/icon-itsk.png') ?>">
            ...
            <div class="header">
                <div class="logo">
                    <a href="<?= site_url('dashboard') ?>">
                        <img style="max-width: 70px;" src="<?= base_url('public') ?>/icon-itsk.png" alt="Logo">
                        <img style="max-width: 70px;" class="logo-fold" src="<?= base_url('public') ?>/icon-itsk.png" alt="Logo">
                    </a>
                </div>
