...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('public/icon-itsk.png') ?>">
	<title><?= APP_NAME . ' ' . INSTANSI_NAME ?> &mdash; <?= (!empty($judul_title) ? $judul_title : 'index') ?></title>
	<!-- Core css -->
	<link href="<?= base_url('public/enlink') ?>/assets/css/app.min.css" rel="stylesheet">
	<!-- Core Vendors JS -->
