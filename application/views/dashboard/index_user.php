<div class="card">
	<div class="card-body">
		<h3>Selamat Datang <b><?= getSession('realName') ?></b></h3>
		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= currencyIDR($tot_piutang) ?></h2>
						<p class="m-b-0 text-muted">Piutang Jatuh Tempo</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= currencyIDR($tot_hutang) ?></h2>
						<p class="m-b-0 text-muted">Hutang Jatuh tempo</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= $tot_stockMin ?></h2>
						<p class="m-b-0 text-muted">Stok Minimum</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= currencyIDR($tot_penj) ?></h2>
						<p class="m-b-0 text-muted">Omset Hari Ini</p>
					</div>
				</div>
			</div>
		</div>
							...
							<tbody>
									...
									<td>
										<div class="media align-items-center">
											<div class="avatar avatar-image rounded">
												<img src="<?= base_url('public/enlink') ?>/assets/images/others/thumb-9.jpg" alt="">
											</div>
											<div class="m-l-10">
												<span>Gray Sofa</span>
											</div>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<div class="avatar avatar-image rounded">
												<img src="<?= base_url('public/enlink') ?>/assets/images/others/thumb-10.jpg" alt="">
											</div>
											<div class="m-l-10">
												<span>Gray Sofa</span>
											</div>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<div class="avatar avatar-image rounded">
												<img src="<?= base_url('public/enlink') ?>/assets/images/others/thumb-11.jpg" alt="">
											</div>
											<div class="m-l-10">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<div class="avatar avatar-image rounded">
												<img src="<?= base_url('public/enlink') ?>/assets/images/others/thumb-12.jpg" alt="">
											</div>
											<div class="m-l-10">
												<span>Red Chair</span>
											</div>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<div class="avatar avatar-image rounded">
												<img src="<?= base_url('public/enlink') ?>/assets/images/others/thumb-13.jpg" alt="">
											</div>
											<div class="m-l-10">
												<span>Wristband</span>
											</div>
