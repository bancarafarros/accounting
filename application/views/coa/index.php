                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col col-sm-4 form-group selG" style="display: none" id="">
                                    <label name="" class="col-sm text-left control-label col-form-label" for="">Sub Grup<b class="text-danger"> *</b></label>
                                    <!-- <input class="form-control e_grup perkiraan" type="text" name="grup" data-grup="MODAL" id="grup"> -->
                                    <!-- <input class="form-control e_grup perkiraan" type="text" name="grup" data-grup="<?= @$detail->grup ?>" id="grup"> -->
                                    <div class="row col-md-12">
