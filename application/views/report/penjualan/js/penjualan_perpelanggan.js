...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + '/report/penjualan/penjualan_perpelanggan_pdf?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/penjualan/penjualan_perpelanggan_data',
        type: "POST",
        data: {
