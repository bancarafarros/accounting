...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + 'report/pelanggan/pdf_piutang_detail?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/pelanggan/piutang_detail_data',
        type: "POST",
        data: {
