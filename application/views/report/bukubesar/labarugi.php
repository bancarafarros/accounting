...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-0">
            <h4 class="text-center font-weight-bolder text-bold text-uppercase">LABA RUGI TAHUNAN</h4>
            <p class="text-center">s/d Tanggal: <b id="per-tanggal"><?= $tanggal_indo ?></b></p>
            <div id="laporan">
                ...
                <table>
                    <tr style="border-bottom: 1px solid;text-align:right;">
                        <td colspan="3" style="text-align:right;"><b>Total Laba: </b><b id="total-laba"></b></td>
                        <!-- <td id="total-laba"></td> -->
                    </tr>
                </table>
