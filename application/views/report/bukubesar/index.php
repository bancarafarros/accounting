            ...
            <table class="table table-hover" width="100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/bukubesar/neraca') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/bukubesar/labarugi') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">3</th>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/bukubesar/labarugi_bulanan') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">4</th>
