        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-sm-6">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a id="link-cetak" href="<?= site_url('report/bukubesar/pdfneraca/' . $tanggal) ?>" target="_blank" role="button" class="btn btn-success"><i class="fa fa-print"></i> Cetak</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="mt-0">
            <h4 class="text-center font-weight-bolder text-bold text-uppercase">NERACA</h4>
