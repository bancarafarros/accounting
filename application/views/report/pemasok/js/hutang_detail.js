...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + 'report/pemasok/hutang_detail_pdf?tgl_awal=' + tanggal_awal + '&tgl_akhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + "/report/pemasok/hutang_detail_data",
        type: "POST",
        data: {
        ...
        success: function (response) {
            hideLoading();
            $('#detail-hutang').html(response.data);
