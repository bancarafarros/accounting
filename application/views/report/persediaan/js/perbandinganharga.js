...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + '/report/persediaan/pdf_perbandinganharga?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/persediaan/perbandingan_harga_data',
        type: "POST",
        data: {
