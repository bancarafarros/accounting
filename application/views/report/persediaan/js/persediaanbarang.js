...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + '/report/persediaan/pdf_persediaanbarang?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/persediaan/persediaan_barang_data',
        type: "POST",
        data: {
