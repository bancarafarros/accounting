...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + '/report/pembelian/barangmasuk_pdf?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/pembelian/barangmasuk_data',
        type: "POST",
        data: {
