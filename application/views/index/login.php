<div class="container-fluid p-0 h-100">
	<div class="row no-gutters h-100 full-height">
		<div class="col-lg-6 d-none d-lg-flex bg" style="background-image:url('<?= base_url('public') ?>/bg.jpg')">
			<div class="d-flex h-100 p-h-40 p-v-15 flex-column justify-content-between">
				<a href="<?= site_url() ?>">
					<div>
						<img style="max-width: 100px;" class="img-fluid" src="<?= base_url('public') ?>/icon-itsk.png" alt="logo-itsk">
					</div>
				</a>
				<div>
				...
				<div class="d-flex justify-content-between">
					<span class="text-white">&copy; 2022 - <?= date('Y') ?> &mdash; <a href="<?= site_url() ?>" class="text-light"><?= APP_NAME ?></a></span>
				</div>
			</div>
		</div>
						...
						<form action="<?= site_url() ?>" id="login-form" class="form-horizontal m-t-20" method="post">
							...
							<div class="form-group">
								<div class="row d-flex justify-content-around align-items-center">
									...
									<button class="btn btn-success rounded-sm py-2 px-4 text-light" type="button" onclick="loadCaptcha()"><i class="fas fa-sync"></i></button>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="d-flex align-items-center justify-content-between">
									<button type="submit" name="btn-login" value="login" class=" btn btn-success"><i class="anticon anticon-login "></i> Login</button>
								</div>
							</div>
						</form>
					</div>
