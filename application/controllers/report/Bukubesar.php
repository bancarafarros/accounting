...
class Bukubesar extends BaseController
{
    ...
    public function neraca()
    {
        ...
        $this->data['scripts'] = ['report/bukubesar/js/neraca.js'];
        $this->render('neraca');
    }
    ...
    public function pdfneraca($param)
    {
        $this->load->library('Dom_pdf', 'dom_pdf');
        ...
        $download = false;
        $this->dom_pdf->load_view('report/bukubesar/neraca_pdf', $filename, $x, $download);
    }
    ...
    public function labarugi()
    {
        ...
        array_push($this->bread, ['title' => $title]);
        $this->data['tanggal_indo'] = $this->tanggalindo->konversi($tanggal);
        $this->data['scripts'] = ['report/bukubesar/js/labarugi_tahunan.js'];
        $this->render('labarugi');
    }

    public function labarugi_bulanan()
    {
        $bulan = date('Y-m');
        ...
        $this->data['scripts'] = ['report/bukubesar/js/labarugi_bulanan.js'];
        $this->render('labarugi_bulanan');
    }

    public function labarugi_data()
    {
    ...
    public function labarugibulanan_data()
    {
